    ...
    <div class="row">
        <div class="col-8">
            ...
            <div class="card card-box">
                <form action="{{ route('admin.daily.reports.post') }}" method="post">
                    @csrf
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date form_date" data-date="{{ \Carbon\Carbon::now() }}" data-date-format="dd MM yyyy" data-link-field="dtp_input1">
                                <input id="date" class="form-control" size="16" type="text" name="date" value="{{ \Carbon\Carbon::now()->format('d M Y') }}">
