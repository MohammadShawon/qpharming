...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="white-box">
                <h3><b>INVOICE</b> <span class="pull-right">#{{ $invoice->sale_no }}</span></h3>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-left">
...
{{--                                </h4>--}}
                        ...
                        <div class="pull-right text-right">
                            <address>
                                ...
                                <p class="font-bold addr-font-h4">{{ $invoice->customer->name }}</p>
                                ...
                                @endif
                                <p class="m-t-30">
                                    <b>Invoice Date :</b> <i class="fa fa-calendar"></i> {{ \Carbon\Carbon::parse($invoice->sale_date)->format('D-M-Y') }}
                                </p>
                                <p>
                                    <b>Phone  :</b> {{ $invoice->customer->phone ?? 'N/A' }}
                                </p>
                            </address>
                        </div>
                    </div>
