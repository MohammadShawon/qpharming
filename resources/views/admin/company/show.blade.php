...
@section('content')
    ...
    <div class="btn-group">
        <a style="color:white; font-size:15px; padding: 3px 7px 5px 0;" href="{{ route('admin.company.index') }}" id="addRow1" class="btn deepPink-bgcolor">
        ...
        <div class="white-box">
            ...
            <div class="tab-content">
                <div class="tab-pane active fontawesome-demo" id="tab1">
                    <div id="biography" >
                        <div class="row">
                            <div class="col-md-3 col-6 b-r"> <strong>Company Name</strong>
                                <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6 b-r"> <strong>Opening Balance</strong>
                                <br>
                                <p class="text-muted">{{ $company->opening_balance }}</p>
                            </div>
                            <div class="col-md-3 col-6 b-r"> <strong>Starting Date</strong>
                                <br>
                                <p class="text-muted">{{ $company->created_at->toDayDaTeTimeString() }}</p>
                            </div>
                            <div class="col-md-3 col-6 b-r"> <strong>Status</strong>
                                <br>
                                <p class="text-muted">{{ $company->status }}</p>
                            </div>
