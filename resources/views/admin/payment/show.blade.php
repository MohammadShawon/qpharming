                    ...
                    <div id="biography" >
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6 b-r"> <strong>Payment Amount</strong>
                                <br>
                                <p class="text-muted">{{ $payment->payment_amount }}</p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6 b-r"> <strong>Bank Name</strong>
                                <br>
                                <p class="text-muted">{{ $payment->bank_name }}</p>
                            </div>
                            <div class="col-md-3 col-6 b-r"> <strong>Received By</strong>
                                <br>
                                <p class="text-muted">{{ $payment->received_by }}</p>
                            </div>
