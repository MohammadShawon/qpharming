...
@section('content')
    ...
    <div class="btn-group">
        <a style="color:white; font-size:15px; padding: 3px 7px 5px 0;" href="{{ route('admin.user.index') }}" id="addRow1" class="btn deepPink-bgcolor">
        ...
        <div class="white-box">
            ...
            <div class="p-rl-20">
                <ul class="nav customtab nav-tabs" role="tablist">
                    <li class="nav-item"><a href="#tab1" class="nav-link active"  data-toggle="tab" >About User</a></li>
                </ul>
            </div>
            <!-- Tab panes -->
                ...
                <div class="tab-pane active fontawesome-demo" id="tab1">
                    <div id="biography" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6"> <strong>Role</strong>
                                <br>
                                <p class="text-muted">
