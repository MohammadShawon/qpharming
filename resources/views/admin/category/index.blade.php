...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
                <div class="btn-group">
                    <a href="{{ route('admin.category.create') }}" id="addRow1" class="btn btn-primary" style="font-size:14px; padding: 6px 12px;" >
                        Add New Category <i style="color:white;" class="fa fa-plus"></i>
                    </a>
            ...
            <div class="card card-topline-red">
                <div class="card-head" style="text-align: center;">
                    <header>CATEGORY </header> <span class="btn btn-primary ml-1"> {{ $categories->count() }} </span>
                    <div class="tools">
