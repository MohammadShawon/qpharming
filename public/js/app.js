...
var app = new Vue({
  ...
  computed: {
    average_weight: function average_weight() {
      return Number(this.sold_kg / this.sold_quantity).toFixed(5);
    },
    missing_quantity: function missing_quantity() {
    ...
    missing_kg: function missing_kg() {
    ...
    bonus_chicks: function bonus_chicks() {
      return Number(Number(this.given_chicks_quantity) * 0.03);
    },
    bonus_chicks_money: function bonus_chicks_money() {
    ...
    farm_stock_cutting: function farm_stock_cutting() {
      return Number(Number(this.farm_stock_kg) * Number(this.selling_rate));
    },
    excess_dead_cutting: function excess_dead_cutting() {
      return Number(Number(this.excess_dead) * Number(this.chicks_rate));
    },
    missing_chicks_cutting: function missing_chicks_cutting() {
    ...
    total_cutting_amount: function total_cutting_amount() {
...
module.exports = __webpack_require__(/*! /Users/shawon/Documents/qfarming/resources/js/app.js */"./resources/js/app.js");
